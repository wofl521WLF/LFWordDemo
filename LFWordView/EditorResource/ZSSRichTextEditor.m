...
- (void)createToolbar {
    NSArray *items = @[
                       [UIImage imageNamed:@"text-bold"],
                       [UIImage imageNamed:@"text-underline"],
                       [UIImage imageNamed:@"text-color"],
                       [UIImage imageNamed:@"text-size"],
                       [UIImage imageNamed:@"img"]
                       ];
    NSArray *selectItems = @[
                             [UIImage imageNamed:@"text-bold-active"],
                             [UIImage imageNamed:@"text-underline-active"],
                             [UIImage imageNamed:@"text-color"],
                             [UIImage imageNamed:@"text-size"],
                             [UIImage imageNamed:@"img"]
                             ];
    ...
    [self.lfToolBar addTarget:self action:@selector(changeTextInputView:) forControlEvents:UIControlEventValueChanged];
